...
**轻燕数智·轻燕** 是一款专为公司系统设计的轻量化情指行一体化支撑解决方案，以"电脑桌面便签"为唯一统一入口，承载被动接单、主动记工、即时协同全场景。系统包含桌面端（WinUI 3）、Web管理端（Vue 3）和大屏端，实现任务接收、工作记录、协同反馈、盯办预警的极致轻量化体验。

### 核心理念
- **无感嵌入办公环境**：以桌面悬浮便签为载体，不改变员工原有电脑操作习惯
...
| 部门管理员 | 本部门 | 部门内人员管理、便签管理、盯办操作 |
| 组长 | 本组 | 小组内任务分配、盯办、协同管理 |
| 普通用户 | 个人 | 个人便签管理、协作参与 |

### 核心工作流程

1. **任务接收**：通过桌面端接收指派任务，黄色便签闪烁提醒
2. **工作执行**：在便签中记录工作进展，支持富文本编辑
3. **协同协作**：邀请相关人员参与协同，实时同步工作内容
4. **任务完成**：点击完成按钮，便签变绿并归档
...
- **协同管理**: `/api/v1/groups/*`, `/api/v1/rooms/*`
